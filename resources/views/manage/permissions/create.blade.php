				...
				<div class="card-content">
					<form action="{{route('permission.store')}}" method="POST">
						...
						<div class="field" v-if="permissionType == 'crud'">
							<label for="resrouce" class="label">Resource</label>
							<p class="control">
						...
						<div class="columns" v-if="permissionType == 'crud'">
							<div class="column">
								<b-checkbox-group v-model="crudSelected">
									<div class="field">
										<b-checkbox custom-value="create">
											Create
										</b-checkbox>
									</div>
									<div class="field">
										<b-checkbox custom-value="read">
											Read
										</b-checkbox>
									</div>
									<div class="field">
										<b-checkbox custom-value="update">
											Update
										</b-checkbox>
									</div>
									<div class="field">
										<b-checkbox custom-value="delete">
											Delete
										</b-checkbox>
									</div>
								</b-checkbox-group>
	...
	var app = new Vue({
		...
		methods:{
			crudName:function(item){
				return item.substr(0,1).toUpperCase()+item.substr(1)+" "+app.resource.substr(1);
			}
			crudSlug:function(item){
				return item.toLowerCase()+"-"+app.resource.toLowerCase();
			}
			crudDescription:function(item){
				return "Allow a User to "+item.toUpperCase()+" a "+app.resource.substr(1);
			}
		}
	});
</script>
